...
// Add smooth scroll animation when articles expand/collapse
...
<h1 class="section-heading">My Perspectives on UX Research</h1>
...
<div class="highlight-banner">
  ...
  <ul class="writings-questions">
    <li>How do we choose methods that serve people and not just metrics?</li>
    <li>How does cognitive psychology inform usable, inclusive design?</li>
    <li>How can we ensure our work remains critical, ethical, and human?</li>
  </ul>

  <p class="writings-intro" style="margin-top: 1.5rem;">
...
::: {.g-col-12 .g-col-md-6 .article-card-wrapper}
<div class="article-card">
<h2>How to Select the Right Research Method for Your UX Project</h2>
...
<div class="read-more-btn" onclick="toggleArticle('article1')">Read more <i class="bi bi-chevron-down"></i></div>
...
::: {.g-col-12 .g-col-md-6 .article-card-wrapper}
<div class="article-card">
<h2>The Psychology Behind Creating a User-Centered Design</h2>
...
<div class="read-more-btn" onclick="toggleArticle('article2')">Read more <i class="bi bi-chevron-down"></i></div>
...
::: {.g-col-12 .g-col-md-6 .article-card-wrapper}
<div class="article-card">
<h2>Mixed Methods in UX Research: Combining Qualitative and Quantitative Approaches</h2>
...
<div class="read-more-btn" onclick="toggleArticle('article3')">Read more <i class="bi bi-chevron-down"></i></div>
...
::: {.g-col-12 .g-col-md-6 .article-card-wrapper}
<div class="article-card">
<h2>The Role of Data Analysis in Modern UX Research</h2>
...
<div class="read-more-btn" onclick="toggleArticle('article4')">Read more <i class="bi bi-chevron-down"></i></div>
...
::: {.g-col-12 .g-col-md-6 .article-card-wrapper}
<div class="article-card">
<h2>Ethical Considerations in UX Research</h2>
...
<div class="read-more-btn" onclick="toggleArticle('article5')">Read more <i class="bi bi-chevron-down"></i></div>
...
::: {.g-col-12 .g-col-md-6 .article-card-wrapper}
<div class="article-card">
<h2>From Research to Action: Translating UX Insights into Design Decisions</h2>
...
<p class="article-intro">
The truth is, conducting great research is only half the job. The other half—and arguably the harder part—is making that research <strong>usable</strong>: understood by stakeholders, embraced by designers, acted on by teams.
</p>

<div class="read-more-btn" onclick="toggleArticle('article6')">Read more <i class="bi bi-chevron-down"></i></div>
